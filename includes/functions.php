<?php
	...
	function add_data_fields ($object, $box) {
		...
		<?php	
				...
				generate_check_filed(__('503', 'maintenance'), __('Service temporarily unavailable, Google analytics will be disable, Google analytics will be disable', 'maintenance'), '503_enabled', '503_enabled',  isset($mt_option['503_enabled']));
