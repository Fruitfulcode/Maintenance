...
function(){if(svgfilters)$("filter#blur-effect-id-"+this.$elm.data("vague-filter-id")).parent().remove();this.unblur()};return this.init()};$.fn.Vague=function(options){return new Vague(this,options)};window.Vague=Vague})(window,document,jQuery);jQuery(document).ready(function() { if (jQuery(window).height() < 768) { jQuery("body").backstretch("http://test.we.co.ua/wp-content/uploads/2017/04/mt-sample-background.jpg"); }	else {  jQuery(".main-container").backstretch(["http://test.we.co.ua/wp-content/uploads/2017/04/mt-sample-background.jpg"], {bypassCss: true}); } });