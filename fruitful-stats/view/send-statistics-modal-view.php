<div class="frtfl-modal modal" id="subscribe-notification-container">
	<form action="#" id="frtfl-modal-form">
		<div class="frtfl-modal__content">
			<h2><?php _e('Please, help us perform better!', 'maintenance'); ?></h2>
			<p class="description">
			...
			<div class="form-group">
				<label>
					<input type="checkbox"
					       ...
					       value="1"
					       checked>
					<?php _e('Send statistics to Fruitful Code', 'maintenance') ?>
				</label>
			</div>
			...
			<div class="form-group submit-btn__wrapper">
				<button id="frtfl-modal__submit-btn"
				        class="button button-primary"><?php _e('Submit', 'maintenance'); ?></button>
			</div>
		</div>
