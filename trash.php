...
function maintenance_page_create_meta_boxes() {
    global $options_page;
    add_meta_box( 'maintenance-general', __( 'General Settings', 'maintenance' ),  'add_data_fields', $options_page, 'normal', 'default');
    add_meta_box( 'maintenance-css', 	 __( 'Custom CSS', 'maintenance' ),        'add_css_fields', $options_page, 'normal', 'default');
    add_meta_box( 'maintenance-excludepages', 	 __( 'Exclude pages from maintenance mode', 'maintenance' ), 'add_exclude_pages_fields', $options_page, 'normal', 'default');
}
add_action('add_mt_meta_boxes', 'maintenance_page_create_meta_boxes', 10);

function maintenance_page_create_meta_boxes_widget_pro() {
    global $options_page;
    add_meta_box( 'promo-extended',   	 __( 'Pro version', 'maintenance' ),  'maintenanace_extended_version',  $options_page, 'side',   'default' );
}
...
function maintenance_page_create_meta_boxes_our_themes() {
    global $options_page;
    add_meta_box( 'promo-our-themes',   	 __( 'Fruitful Code projects',  'maintenance' ),  'maintenanace_our_themes',   $options_page, 'side',   'default' );
}
...
function maintenance_page_create_meta_boxes_widget_support() {
    global $options_page;
    add_meta_box( 'promo-content',   	 __( 'Support',  'maintenance' ),  'maintenanace_contact_support',   $options_page, 'side',   'default' );
}
...
function maintenance_page_create_meta_boxes_improve_translate() {
    global $options_page;
    add_meta_box( 'promo-translate',   	 __( 'Translation',  'maintenance' ),  'maintenanace_improve_translate',   $options_page, 'side',   'default' );
}
...
function maintenance_metaboxes_scripts() {
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready( function() {
            ...
            postboxes.add_postbox_toggles( '<?php echo esc_js($options_page); ?>' );
        });
        //]]>
    </script>
<?php }
